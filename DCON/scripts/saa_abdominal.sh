#!/bin/bash
# SAA mainline training script for the ABDOMINAL dataset.
#
# View construction:
# 1. View1 = GIP(x)
# 2. View2 = SGF(GIP, CLP)
...
domains=('CHAOST2' 'SABSCT')

for dm in "${domains[@]}"
do
   echo "=========================================="
   echo "SAA mainline: training ABDOMINAL on domain $dm"
   echo "=========================================="
...
echo "=========================================="
echo "SAA mainline ABDOMINAL experiments completed!"
echo "=========================================="
