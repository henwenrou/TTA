...
_C.GOLD.LAMBDA_CE_TRG = 1.0          # Lambda for self-training
_C.GOLD.LAMBDA_CONT = 1.0            # Lambda for contrastive learning
_C.GOLD.NUM_SAMPLES_WARM_UP = 50000
_C.GOLD.ALPHA = 0.1
_C.GOLD.TOP_R = 64
_C.GOLD.CONF_THRESH = 0.8
_C.GOLD.UPDATE_EVERY = 50
_C.GOLD.ADAPTER_LR_SCALE = 1
...
# --------------------------------- OBAO options ----------------------------- #
_C.OBAO = CfgNode()
_C.OBAO.LAMBDA_CE_SRC = 0.0          
_C.OBAO.LAMBDA_CE_TRG = 1.0          
_C.OBAO.NUM_SAMPLES_WARM_UP = 50000  
_C.OBAO.LAMBDA_CE_LOW_ENT = 0.0      
_C.OBAO.LAMBDA_CRP = 200.0
_C.OBAO.BUFFER_SIZE = 1000
_C.OBAO.BUFFER_BS_SIZE = 200
_C.OBAO.ORG_CLASS_RELATION_FORM = "proto" 
_C.OBAO.CLASS_RELATION_TYPE = "cos"
_C.OBAO.CLASS_RELATION_LOSS_TYPE = "t"  
_C.OBAO.E_MARGIN = 0.1               
_C.OBAO.RST = 0.0                    
# --------------------------------- AdaContrast options --------------------- #
