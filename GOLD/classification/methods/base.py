...
class TTAMethod(nn.Module):
    def __init__(self, cfg, model, num_classes):
        ...
        self.adapter_S = nn.Parameter(torch.ones(self.top_r, device=self.device))
        self.params = "full" if self.dataset_name == 'cifar10_c' or self.dataset_name == 'cifar100_c' else "norm"
