...
class CardiacDataset(torch_data.Dataset):
    def __init__(self,  mode, transforms, base_dir, domains: list, tile_z_dim = 3, extern_norm_fn = None, location_scale=False, local_aug_type='affine_clp'):
        """
        Args:
...
def get_training(modality, location_scale,  tile_z_dim = 3, local_aug_type='affine_clp'):
